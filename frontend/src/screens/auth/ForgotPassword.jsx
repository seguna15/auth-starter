  ...
  return (
    ...
    >
            ...
            </h2>
            {
                !isSubmitted ? (
                    <form onSubmit={handleSubmit}>
                        <p className='mb-6 text-center text-gray-300'>Enter your email and we'll send you a link to reset your password.</p>
        ...
        <div className='flex justify-center px-8 py-4 bg-gray-900 bg-opacity-50'>
            <Link to={"/auth/login"} className="flex items-center text-sm text-green-400 hover:underline">
